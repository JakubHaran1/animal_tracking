...
ALLOWED_HOSTS = [
    host.strip()
    for host in getenv('ALLOWED_HOSTS', 'localhost,127.0.0.1').split(',')
    if host.strip()
]
...
if DB_ENGINE == 'postgres':
    DATABASES = {
        'default': {
            ...
            'NAME': getenv('POSTGRES_DB', 'nowatorski'),
            'USER': getenv('POSTGRES_USER', 'nowatorski'),
            'PASSWORD': getenv('POSTGRES_PASSWORD', 'nowatorski'),
